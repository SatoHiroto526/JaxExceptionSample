...
public class ApiTest {
	...
	//URI定義
	private final String getUri = "http://localhost:8080/JaxExceptionSample/rest/api/getlist";
	private final String postUri = "http://localhost:8080/JaxExceptionSample/rest/api/getbyid";
	...
	public void postRequestTest() {
		...
		Response response = target.request(MediaType.APPLICATION_JSON).post(Entity.entity(requestBody, MediaType.APPLICATION_JSON));
